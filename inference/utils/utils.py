...
def construct_prompt(args, example):
    if args.prompt_type == "tora":
        if "gemma" in args.model_name_or_path:
            ...
            full_prompt = f"<|begin_of_text|><|start_header_id|>user<|end_header_id|>\n\nYou are a reasoning assistant tasked with solving math problems using chain-of-thought (CoT) reasoning. Your goal is to iteratively improve your responses based on feedback provided as a reward score. This process will repeat multiple times until the reasoning achieves a satisfactory reward score.\n\nProblem:\n{example['question']}\nPlease reason step by step, and put your final answer within \\boxed{{}}<|eot_id|><|start_header_id|>assistant<|end_header_id|>\n\n"
        else:
